                    ...
                    <div className="row g-5">
                        <div className="col-xl-6 wow fadeInLeft " data-wow-delay="0.2s">
                            <div className="about-item-content bg-white rounded p-5 h-100 d-flex align-items-center">
                                <div>
                                    <h4 className="text-primary">About Avataworks</h4>
                                    <h1 className="display-4 mb-4 text-capitalize">Your All-in-One Digital Team—Powered by AVATAs</h1>
                                    ...
                                    <a className="btn btn-primary rounded-pill py-3 px-5 text-capitalize" href="#">meet the avatas</a>
                                </div>
                            </div>
                        </div>
