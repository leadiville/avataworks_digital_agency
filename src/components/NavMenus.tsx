    ...
    return (
        <div className="collapse navbar-collapse mt-4 mb-2 mt-lg-0 mb-lg-0" id="navbarToggleMenu">
            <div className="w-100 d-lg-flex justify-content-center align-items-center">
                <div className="col-lg-10 col-12 bg-white border border-white position-relative z-1 p-3 p-lg-1 px-lg-5 rounded d-lg-flex justify-content-between d-grid">
                    ...
                    <span className='nav-item-container'>{<FontAwesomeIcon icon={faReceipt} className='d-lg-none text-primary' />}<Link href="our-works" className={`${setActive("/our-works")} nav-item my-lg-0 my-2`}>Our Works</Link></span>
                    <Link className=' d-lg-none mx-lg-0 ms-2 mb-2 mb-lg-0 my-3' href={"/get-quote"}><PrimaryButton className='btn-danger' text='Get Started' icon={faArrowRight} /></Link>
                </div>
            </div>
        </div>
    )
