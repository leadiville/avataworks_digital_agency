            ...
            <div className={`${style ? 'bg-primary' : 'bg-white'} w-100 px-4 px-lg-0`}>
                <div className="position-relative">
                    <div className={`row rounded gap-0 justify-content-center ${style ? 'text-white' : 'text-primary'}`}>
                        {!isWorks &&
                            (<>
                                <div className="col-3 border-top border-primary text-centerd d-grid text-center py-4 px-0 "><span className="stat-num display-6 fw-bold ">30+</span><small>Brands Managed</small></div>
                                ...
                                <div className="col-3 border-start border-top border-primary text-centerd d-grid text-center py-4 px-0 "><span className="stat-num display-6 fw-bold ">10+</span><small>Avatas in the Loop</small></div>
                            </>)
                        }
