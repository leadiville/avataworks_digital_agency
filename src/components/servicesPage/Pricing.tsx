...
const Pricing = () => {
    const [pricing, setPricing] = useState<PricingI[]>(pricingData);
        ...
        <section className="sec sec-alt bg-primaryLight position-relative z-1">
            <div className="c">
                <div className="sec-hdr">
                    <div className="badge"><span className="bdot"></span>{"welcome to services"}</div>
                    <h2>Productized Plans for<br />Nigerian Businesses</h2>
                    <p>Fixed pricing. Defined deliverables. No opaque retainer fees. Join the waitlist for early-access pricing.</p>
                </div>
                <div className="pg-grid">
                    {pricing?.map((each, eachInx) => {
                        ...
                        return (
                            <div className="pc" key={eachInx}>
                                <div className="pt">{ourPlans}</div>
                                <div className="pn">{type}</div>
                                <div className="pa">{price}</div>
